...
export function graphql(
	source: "mutation CartAddProduct($cartId: ID!, $productId: ID!, $total: Int!, $quantity: Int!, $orderItemId: ID) {\n  upsertOrderItem(\n    upsert: {create: {quantity: $quantity, total: $total, product: {connect: {id: $productId}}, order: {connect: {id: $cartId}}}, update: {quantity: $quantity, total: $total, product: {connect: {id: $productId}}, order: {connect: {id: $cartId}}}}\n    where: {id: $orderItemId}\n  ) {\n    id\n  }\n}",
 ...
 */
export function graphql(
	source: "query CollectionsGetListBySlug($slug: String!) {\n  collections(where: {slug: $slug}) {\n    id\n    name\n    slug\n    description\n    products {\n      ...ProductListItem\n    }\n  }\n}",
 ...
 */
export function graphql(
	source: "mutation ProductPublish($id: ID!) {\n  publishProduct(where: {id: $id}, to: PUBLISHED) {\n    ...ProductListItem\n  }\n}",
): typeof import("./graphql").ProductPublishDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
	source: "query ProductsCount {\n  productsConnection {\n    aggregate {\n      count\n    }\n  }\n}",
 ...
 */
export function graphql(
	source: "query ProductsGetById($id: ID!) {\n  product(where: {id: $id}) {\n    ...ProductListItem\n  }\n}",
): typeof import("./graphql").ProductsGetByIdDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
	source: "query ProductGetByPage($skip: Int!, $first: Int!) {\n  products(skip: $skip, first: $first) {\n    ...ProductListItem\n  }\n}",
): typeof import("./graphql").ProductGetByPageDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
	source: "query ProductsGetList($first: Int, $skip: Int, $query: String, $orderBy: ProductOrderByInput) {\n  products(\n    where: {name_contains: $query}\n    first: $first\n    skip: $skip\n    orderBy: $orderBy\n  ) {\n    ...ProductListItem\n  }\n  productsConnection(where: {name_contains: $query}) {\n    pageInfo {\n      pageSize\n    }\n  }\n}",
): typeof import("./graphql").ProductsGetListDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
	source: "query ProductsGetByRecommendedCategory($slug: String!) {\n  categories(where: {slug: $slug}) {\n    products(first: 5) {\n      ...ProductListItem\n    }\n  }\n}",
): typeof import("./graphql").ProductsGetByRecommendedCategoryDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
	source: "query ProductsRelated {\n  products(first: 4) {\n    id\n    name\n    description\n    categories(first: 1) {\n      name\n    }\n    images(first: 1) {\n      url\n    }\n    price\n    reviews {\n      ...ReviewItem\n    }\n  }\n}",
): typeof import("./graphql").ProductsRelatedDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
	source: "mutation ReviewCreate($id: ID!, $headline: String!, $name: String!, $email: String!, $content: String!, $rating: Int!) {\n  createReview(\n    data: {headline: $headline, name: $name, email: $email, content: $content, rating: $rating, product: {connect: {id: $id}}}\n  ) {\n    ...ReviewItem\n  }\n}",
): typeof import("./graphql").ReviewCreateDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
	source: "fragment ReviewItem on Review {\n  id\n  name\n  headline\n  email\n  content\n  rating\n  stage\n}",
 ...
 */
export function graphql(
	source: "mutation ReviewUpdateAverageRating($id: ID!, $averageRating: Int) {\n  updateProduct(where: {id: $id}, data: {averageRating: $averageRating}) {\n    id\n  }\n}",
