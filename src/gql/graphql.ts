...
export type CategoryUpdateManyInlineInput = {
	...
	update?: InputMaybe<
		Array<CategoryUpdateWithNestedWhereUniqueInput>
	>;
	/** Upsert multiple Category documents */
	upsert?: InputMaybe<
		Array<CategoryUpsertWithNestedWhereUniqueInput>
	>;
};
...
export type CollectionUpdateManyInlineInput = {
	...
	update?: InputMaybe<
		Array<CollectionUpdateWithNestedWhereUniqueInput>
	>;
	/** Upsert multiple Collection documents */
	upsert?: InputMaybe<
		Array<CollectionUpsertWithNestedWhereUniqueInput>
	>;
};
...
export type CurrencyUpdateManyInlineInput = {
	...
	update?: InputMaybe<
		Array<CurrencyUpdateWithNestedWhereUniqueInput>
	>;
	/** Upsert multiple Currency documents */
	upsert?: InputMaybe<
		Array<CurrencyUpsertWithNestedWhereUniqueInput>
	>;
};
...
export type OrderItemUpdateManyInlineInput = {
	...
	update?: InputMaybe<
		Array<OrderItemUpdateWithNestedWhereUniqueInput>
	>;
	/** Upsert multiple OrderItem documents */
	upsert?: InputMaybe<
		Array<OrderItemUpsertWithNestedWhereUniqueInput>
	>;
};
...
export type OrderManyWhereInput = {
	...
	/** All values not containing the given string. */
	stripeCheckoutId_not_contains?: InputMaybe<
		Scalars["String"]["input"]
	>;
	/** All values not ending with the given string */
	stripeCheckoutId_not_ends_with?: InputMaybe<
		Scalars["String"]["input"]
	>;
	/** All values that are not contained in given list. */
	...
	>;
	/** All values not starting with the given string. */
	stripeCheckoutId_not_starts_with?: InputMaybe<
		Scalars["String"]["input"]
	>;
	/** All values starting with the given string. */
	stripeCheckoutId_starts_with?: InputMaybe<
		Scalars["String"]["input"]
	>;
	total?: InputMaybe<Scalars["Int"]["input"]>;
	/** All values greater than the given value. */
...
export type ProductColorVariantCreateLocalizationsInput = {
	/** Create localizations for the newly-created document */
	create?: InputMaybe<
		Array<ProductColorVariantCreateLocalizationInput>
	>;
};
...
export type ProductColorVariantUpdateLocalizationsInput = {
	...
	/** Localizations to update */
	update?: InputMaybe<
		Array<ProductColorVariantUpdateLocalizationInput>
	>;
	upsert?: InputMaybe<
		Array<ProductColorVariantUpsertLocalizationInput>
	>;
};
...
export type ProductColorVariantUpdateManyLocalizationsInput = {
	/** Localizations to update */
	update?: InputMaybe<
		Array<ProductColorVariantUpdateManyLocalizationInput>
	>;
};
...
export type ProductManyWhereInput = {
	...
	/** All values that are not contained in given list. */
	averageRating_not_in?: InputMaybe<
		Array<InputMaybe<Scalars["Int"]["input"]>>
	>;
...
export type ProductSizeColorVariantCreateLocalizationsInput = {
	/** Create localizations for the newly-created document */
	create?: InputMaybe<
		Array<ProductSizeColorVariantCreateLocalizationInput>
	>;
};
...
export type ProductSizeColorVariantCreateManyInlineInput = {
	...
	connect?: InputMaybe<
		Array<ProductSizeColorVariantWhereUniqueInput>
	>;
...
export type ProductSizeColorVariantUpdateLocalizationsInput = {
	...
	/** Localizations to update */
	update?: InputMaybe<
		Array<ProductSizeColorVariantUpdateLocalizationInput>
	>;
	upsert?: InputMaybe<
		Array<ProductSizeColorVariantUpsertLocalizationInput>
	>;
};
...
export type ProductSizeVariantCreateLocalizationsInput = {
	/** Create localizations for the newly-created document */
	create?: InputMaybe<
		Array<ProductSizeVariantCreateLocalizationInput>
	>;
};
...
export type ProductSizeVariantUpdateLocalizationsInput = {
	...
	/** Localizations to update */
	update?: InputMaybe<
		Array<ProductSizeVariantUpdateLocalizationInput>
	>;
	upsert?: InputMaybe<
		Array<ProductSizeVariantUpsertLocalizationInput>
	>;
};
...
export type ProductSizeVariantUpdateManyLocalizationsInput = {
	/** Localizations to update */
	update?: InputMaybe<
		Array<ProductSizeVariantUpdateManyLocalizationInput>
	>;
};
...
export type ProductVariantsUpdateManyInlineInput = {
	...
	update?: InputMaybe<
		Array<ProductVariantsUpdateWithNestedWhereUniqueInput>
	>;
	/** Upsert multiple ProductVariants documents */
	upsert?: InputMaybe<
		Array<ProductVariantsUpsertWithNestedWhereUniqueInput>
	>;
};
...
export type CartAddProductMutation = {
	upsertOrderItem?: { id: string } | null;
};
...
export type CartRemoveProductMutation = {
...
export type CartSetProductQuantityMutation = {
	updateOrderItem?: { id: string; quantity: number } | null;
};
...
export type CollectionsGetListBySlugQuery = {
	collections: Array<{
		id: string;
		name: string;
		slug: string;
...
export type ProductPublishMutation = {
	publishProduct?: {
		id: string;
		name: string;
		description: string;
...
export type ProductsGetByIdQuery = {
	product?: {
		id: string;
		name: string;
		description: string;
...
export type ProductsGetByRecommendedCategoryQueryVariables = Exact<{
	slug: Scalars["String"]["input"];
}>;

export type ProductsGetByRecommendedCategoryQuery = {
	categories: Array<{
		products: Array<{
			id: string;
			name: string;
...
export type ProductsRelatedQueryVariables = Exact<{
	[key: string]: never;
}>;

export type ProductsRelatedQuery = {
	products: Array<{
		id: string;
		name: string;
		description: string;
...
export type ReviewPublishMutation = {
	publishReview?: {
		id: string;
		name: string;
		headline: string;
...
export type ReviewUpdateAverageRatingMutation = {
...
export const ReviewItemFragmentDoc = new TypedDocumentString(
  ...
  stage
    ...
    `,
	{ fragmentName: "ReviewItem" },
) as unknown as TypedDocumentString<ReviewItemFragment, unknown>;
...
export const CartAddProductDocument = new TypedDocumentString(`
  ...
  upsertOrderItem(
	...
	CartAddProductMutationVariables
>;
...
>;
export const CartSetProductQuantityDocument =
  ...
  updateOrderItem(where: {id: $itemId}, data: {quantity: $quantity}) {
	...
	>;
export const CollectionsGetListBySlugDocument =
	new TypedDocumentString(`
...
fragment ReviewItem on Review {
  ...
  stage
		...
		CollectionsGetListBySlugQuery,
		CollectionsGetListBySlugQueryVariables
	>;
...
fragment ReviewItem on Review {
  ...
  stage
	...
	CollectionsGetListQuery,
	CollectionsGetListQueryVariables
>;
...
fragment ReviewItem on Review {
  ...
  stage
	...
	ProductsGetByIdQuery,
	ProductsGetByIdQueryVariables
>;
...
fragment ReviewItem on Review {
  ...
  stage
	...
	ProductGetByPageQuery,
	ProductGetByPageQueryVariables
>;
...
>;
export const ProductsGetByRecommendedCategoryDocument =
	new TypedDocumentString(`
...
fragment ReviewItem on Review {
  ...
  stage
		...
		ProductsGetByRecommendedCategoryQuery,
		ProductsGetByRecommendedCategoryQueryVariables
	>;
...
export const ReviewPublishDocument = new TypedDocumentString(`
  ...
  stage
	...
	ReviewPublishMutation,
	ReviewPublishMutationVariables
>;
export const ReviewUpdateAverageRatingDocument =
	new TypedDocumentString(`
  ...
  updateProduct(where: {id: $id}, data: {averageRating: $averageRating}) {
    ...
    `) as unknown as TypedDocumentString<
		ReviewUpdateAverageRatingMutation,
		ReviewUpdateAverageRatingMutationVariables
	>;
